...
pub const JUNCTION_LOGO_PNG: &[u8] = include_bytes!("../resources/Junction-VIII.png");
...
pub const JUNCTION_VIII_SETTINGS_XML: &str =
    include_str!("../resources/junction_viii_settings.xml");
